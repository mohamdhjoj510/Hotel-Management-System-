...
public class Hotel implements Serializable  {
    ...
    //new fields
    public ArrayList<Employee> removedEmployees = new ArrayList<Employee>();
	...
	public ArrayList<Employee> getRemovedEmployees() {
		return removedEmployees;
	}

	public void setRemovedEmployees(ArrayList<Employee> removedEmployees) {
	...
	public boolean addStandardRoom(StandardRoom standardRoom){
    ...
    public boolean addSuperiorRoom(SuperiorRoom superiorRoom){
	...
	public List<Employee> KEmployeesStream(int k){
		...
		public List<Integer> getAllUniqueFloors() {
		...
		public Set<Double> getAllUniqueRoomGrades() {
			Set<Double> uniqueRoomGrades = new HashSet<>();

			for (Room room : allRooms.values()) {
				uniqueRoomGrades.add(room.getRoomGrade());
			}

			return uniqueRoomGrades;
		}

		// Override readResolve to maintain the singleton property during
		// deserialization
